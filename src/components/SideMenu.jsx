    ...
    <>
      ...
      {isOpen && createPortal(
        <>
          ...
          {/* Side Menu */}
          <div className={`side-menu ${openFrom === 'right' ? 'from-right' : 'from-left'} open`}>
            ...
            <div className="menu-content">
                          ...
                          <div className="menu-notification-actions">
                            ...
                            >
                              ...
                              {isFriendRequest
                                ...
                                : t('menu.notificationAcceptInvite')}
                            </button>
                            <button
                              type="button"
              ...
              <div className="menu-section">
                <h4 className="section-title"><Languages size={14} /> {t('menu.language')}</h4>
                <div className="menu-language-grid">
                  {LANGUAGES.map((option) => {
                    ...
                    return (
                      <button
                        key={option.code}
                        className={`menu-language-btn ${isActive ? 'active' : ''}`}
                        onClick={() => handleLanguageChange(option.code)}
                        aria-label={option.label}
                        title={option.label}
                      >
                        <span className="menu-language-flag" aria-hidden>{option.flag}</span>
              ...
              <div className="menu-section">
                ...
                >
                  <span className="menu-collapsible-title">
                    <Newspaper size={14} /> {whatsNew.title}
                  </span>
              ...
              <GoogleAuthButton auth={auth} syncStatus={syncStatus} compact />
            </div>
